<%@ Page Title="" Language="C#" MasterPageFile="~/HospitalMaster.master" AutoEventWireup="true" CodeFile="HospitalOrganHistory.aspx.cs" Inherits="HospitalOrganHistory" %>
	...
	<section id="cta-1" class="section-padding">
		<div class="container">
			<div class="row">
				...
				<div class="container">
					<div class="row">
						<h4>Current Complete Organ Donation To Other Establishment</h4>
						<div class="basic-login">

							<br />
							<asp:Label ID="lblSorry" runat="server" Text="Sorry there are no complete transaction to other establishments" Visible="false"></asp:Label>
						...
						<br />
						<br />
						<h4>Current Complete Organ Donation From Others Establishment</h4>
						<div class="basic-login">

							<br />
							<asp:Label ID="lblsorry2" runat="server" Text="Sorry there are no complete transaction from other establishments" Visible="false"></asp:Label>
							<asp:Panel ID="panelfrom" runat="server" Visible="false">
