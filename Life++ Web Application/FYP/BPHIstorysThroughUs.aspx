<%@ Page Title="" Language="C#" MasterPageFile="~/HospitalMaster.master" AutoEventWireup="true" CodeFile="BPHIstorysThroughUs.aspx.cs" Inherits="BPHIstorysThroughUs" %>
			...
			<div class="row">
				...
				<div class="container">
					<div class="row">
						<br />
						<h4>
							<asp:Label ID="lblHeading" runat="server" Text="Complete Blood/Plateles Transaction Through Us"></asp:Label>


						</h4>
						<div class="basic-login">
							<h5>
								<asp:Label ID="lblSorry" runat="server" Text="There are no complete transaction through us right now" Visible="false">
								</asp:Label>
							</h5>
							<br />
							<asp:Panel ID="Panel1" runat="server" Visible="false">
								<asp:GridView ID="GridView1" runat="server" CssClass="table table-nonfluid .table-striped .table-condensed table-responsive" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" AutoGenerateColumns="False">
									<Columns>
										...
										<asp:BoundField DataField="Status" HeaderText="Establishment" />
									</Columns>
