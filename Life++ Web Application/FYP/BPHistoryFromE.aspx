<%@ Page Title="" Language="C#" MasterPageFile="~/HospitalMaster.master" AutoEventWireup="true" CodeFile="BPHistoryFromE.aspx.cs" Inherits="BPHistoryFromE" %>
			...
			<div class="row">
				...
				<div class="container">
					<div class="row">
						<br />
						<h4>
							<asp:Label ID="lblHeading" runat="server" Text="Complete Blood/Plateles Transaction From Establishments"></asp:Label>


						</h4>
						<div class="basic-login">
							<h5>
								<asp:Label ID="lblSorry" runat="server" Text="There are no complete transaction from Establishment to our hospital right now" Visible="false">
								</asp:Label>
							</h5>
							<br />
