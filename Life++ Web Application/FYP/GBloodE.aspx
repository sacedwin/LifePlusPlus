<%@ Page Title="" Language="C#" MasterPageFile="~/GovernmentMaster.master" AutoEventWireup="true" CodeFile="GBloodE.aspx.cs" Inherits="GBloodE" %>
	...
	<section id="cta-1" class="section-padding">
		<div class="container">
			<div class="row">
				...
				<div class="container">
					<div class="row">
						<h4>Current Request Blood/Plateles By Establishment</h4>
							...
							<asp:Panel ID="Panel1" runat="server" Visible="false">
								<asp:GridView ID="gvRequest" CssClass="table table-nonfluid .table-striped .table-condensed table-responsive" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" AllowPaging="True" PageSize="20" OnPageIndexChanging="gvRequest_PageIndexChanging" >
									<Columns>
										...
										<asp:BoundField DataField="BloodGroup" HeaderText="Blood Type" />
										<asp:BoundField DataField="Type" HeaderText="Request Type" />
										<asp:BoundField DataField="Units" HeaderText="Units Require" />
										<asp:BoundField DataField="MatchedUnits" HeaderText="Units Matched" />
						...
						<br />
						<br />
						<h4>Complete & Cancelled/Expired Request By Establishment</h4>
						<div class="basic-login">
