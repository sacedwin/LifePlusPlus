<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RegisterForm.aspx.cs" EnableEventValidation="false" Inherits="RegisterForm" %>
							...
							<table border="0" cellpadding="0" cellspacing="0" border="0" id="id-form">
								<tr>
									...
									<td class="auto-style1">
										<asp:TextBox ID="tbxName" class="form-control" Width="200" runat="server"></asp:TextBox>
									</td>
									<td>
								...
								<tr>
									<th>Date of Birth:*</th>
									<td class="auto-style1">
										<asp:TextBox ID="tbxDOB" class="form-control" Width="180" runat="server" type="date"></asp:TextBox>
									</td>
									<td>
								...
								<tr>
									<th>Email:*</th>
									<td class="auto-style1">
										<asp:TextBox ID="tbxEmail" class="form-control" Width="250" runat="server" TextMode="Email"></asp:TextBox>
									</td>
									<td>
								...
								<tr>
									<th>Do You Donate Blood Before:*</th>
									<td class="auto-style1">
										<asp:DropDownList ID="ddllastDAsk" AutoPostBack="true" class="form-control" Width="130" runat="server" OnSelectedIndexChanged="ddllastDAsk_SelectedIndexChanged">
											<asp:ListItem Value="0">--Select--</asp:ListItem>
									...
									<td>
										<asp:Label ID="lblldAsk" runat="server" Text="Please choose one answer from the question " Visible="False"></asp:Label>
								...
								<asp:Panel ID="Panel1" runat="server" Visible="false">
									<tr>
										...
										<td class="auto-style1">
											<asp:TextBox ID="tbxlastDonate" class="form-control" Width="180" runat="server" required type="date"></asp:TextBox>
										</td>
										<td>
											<asp:Label ID="lbllastDonate" runat="server" Text="Your last Donation cannot be future date" Visible="False"></asp:Label>
										</td>
									</tr>
									<tr>
										<th>Donation Type:*</th>
								...
								<tr>
									<th>&nbsp;</th>
									<td class="auto-style1">
										<asp:CheckBox ID="CheckTerm" runat="server" Text="&nbsp;I agree to the" />
										<asp:LinkButton ID="linkTerm" runat="server">Terms & Conditions</asp:LinkButton>
									</td>
									<td>
