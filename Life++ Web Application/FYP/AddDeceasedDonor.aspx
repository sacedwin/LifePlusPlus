<%@ Page Title="" Language="C#" MasterPageFile="~/HospitalMaster.master" AutoEventWireup="true" CodeFile="AddDeceasedDonor.aspx.cs" Inherits="AddDeceasedDonor" %>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" border="0" id="id-form">
                               <tr>
                                ...
                                <tr>
								 ...
								 <tr>
                                    <th>Donor Death Date:*</th>
                                    <td class="auto-style1">
                                        <asp:TextBox ID="tbxDeath" class="form-control" Width="180" runat="server" required="true" TextMode="Date"></asp:TextBox>
                                    </td>                                   
                                </tr>
                                <tr>
                                    <th>Organ Type:*</th>
