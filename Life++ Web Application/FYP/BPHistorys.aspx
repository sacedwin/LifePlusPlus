<%@ Page Title="" Language="C#" MasterPageFile="~/HospitalMaster.master" AutoEventWireup="true" CodeFile="BPHistorys.aspx.cs" Inherits="BPHistorys" %>
			...
			<div class="row">
				...
				<div class="container">
					<div class="row">
						<br />
						<h4>
							<asp:Label ID="lblHeading" runat="server" Text="Complete Blood/Plateles Transaction To Establishments"></asp:Label>


						</h4>
						<div class="basic-login">
							<h5>
								<asp:Label ID="lblSorry" runat="server" Text="There are no complete transaction to Establishment right now" Visible="false">
								</asp:Label>
							</h5>
							<br />
