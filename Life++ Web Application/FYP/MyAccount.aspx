                        ...
                        <div class="col-md-12">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" border="0" id="id-form">
                                ...
                                <tr>
                                    <th>Name:</th>
                                    <td class="auto-style1">
                                        <asp:TextBox ID="tbxName" class="form-control" Width="200" runat="server" required></asp:TextBox>
                                    </td>
                                    <td> 
                                    </td>
                                </tr>
                               ...
                               <tr>
                                ...
                                <tr>
                                    <th>Password:*</th>
                                    <td class="auto-style1">
                                        <asp:TextBox ID="tbxPassword" class="form-control" Width="150" runat="server" Text="******" ReadOnly="True" TextMode="SingleLine"></asp:TextBox>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <th>Address:*</th>
                                    <td class="auto-style1">
                                        <asp:TextBox ID="tbxAddress" class="form-control" Width="250" runat="server" TextMode="MultiLine"></asp:TextBox>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <th>ZipCode:*</th>
                                    <td class="auto-style1">
                                        <asp:TextBox ID="tbxZipcode" class="form-control" Width="180" runat="server" required></asp:TextBox>
                                    </td>
                                    <td>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <th>Phone Number:*</th>
                                    <td class="auto-style1">
                                        <asp:TextBox ID="tbxPhone" required class="form-control" Width="180" runat="server"></asp:TextBox>
                                    </td>
                                    <td>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <th>&nbsp;</th>
                                    <td class="auto-style1">
                                     <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click" Text="I want to add emergency contact person for me."></asp:LinkButton>                  
                                    </td>
                                    <td></td>
                                </tr>
