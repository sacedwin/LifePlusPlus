<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SuccessfulDonation.aspx.cs" Inherits="SuccessfulDonation" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-sm-offset-3">
                            <div class="basic-login">
                                ...
                                <div>
                                    <center>
                                            <asp:Label ID="lblemail" runat="server" Text="Donation Successful! Thank you so much for your support." Font-Bold="True" Font-Size="Medium"></asp:Label>
                                        <br />
                                       <br />                                            
                                </center>
                                </div>
