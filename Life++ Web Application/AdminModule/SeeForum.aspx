<%@ Page Title="" Language="C#" MasterPageFile="~/AdminModuleMasterPage.master" AutoEventWireup="true" CodeFile="SeeForum.aspx.cs" EnableEventValidation="false" Inherits="AdminModule_SeeForum" %>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <asp:Panel ID="panelUser" runat="server" Visible="false">
                                    ...
                                    <asp:GridView ID="gvUser" CssClass="table table-nonfluid .table-striped .table-condensed table-responsive" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="5" OnPageIndexChanging="gvUser_PageIndexChanging" OnSelectedIndexChanged="gvUser_SelectedIndexChanged1" OnRowDeleting="gvUser_RowDeleting">
                                        <Columns>
                                ...
                                <asp:Panel ID="panelEst" runat="server" Visible="false">
                                    ...
                                    <asp:GridView ID="gvEst" CssClass="table table-nonfluid .table-striped .table-condensed table-responsive" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="5" OnPageIndexChanging="gvEst_PageIndexChanging" OnSelectedIndexChanged="gvEst_SelectedIndexChanged1" OnRowDeleting="gvEst_RowDeleting">
                                        <Columns>
                                            <asp:BoundField DataField="forumID" HeaderText="forumID">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <asp:Panel ID="Panel1" runat="server" Visible="False">
                                    ...
                                    <br /><br />
                                    <asp:GridView ID="GridView1" CssClass="table table-nonfluid .table-striped .table-condensed table-responsive" Width="100%" runat="server" CellPadding="4" AutoGenerateColumns="False" ForeColor="#333333" GridLines="None"  OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                                        ...
                                        <Columns>
                                           ...
                                           <asp:CommandField HeaderText="Banned Comment" ShowSelectButton="True" SelectText="Change Status" />
                                        </Columns>
