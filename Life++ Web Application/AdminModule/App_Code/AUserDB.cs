...
/// <summary>
/// Summary description for AUserDB
/// </summary>
public class AUserDB
{
    ...
    public static int insertUser(AUser u)
    {
        int num = -1;
        try
        {
    ...
    //get User by Email
    public static AUser getUserbyEmail(string email)
    {
        AUser u = new AUser();
        try
        {
    ...
    public static AUser getUserbyUsername(string username)
    {
        AUser u = new AUser();
        try
        {
    ...
    public static int updateEmergencyUser(AUser u)
    {
        int result;
        try
        {
    ...
    //Update User in the database
    public static int updateUser(AUser u)
    {
        int result;
        try
        {
    ...
    //Update status of uUser in the database
    public static int updateUserstatus(AUser u)
    {
        int result;
        try
        {
            SqlCommand command = new SqlCommand("Update Users set status=@status,doneby=@doneby where email=@email");
            command.Parameters.AddWithValue("@email", u.email);
            command.Parameters.AddWithValue("@status", u.status);
            command.Parameters.AddWithValue("@doneby", u.doneby);
            command.Connection = connection;
